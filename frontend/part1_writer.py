...
# I will build the React code piece by piece.

imports_and_state = """import React, { useState, useEffect, useRef } from 'react';
...
with open("part1.py", "w", encoding="utf-8") as f:
    f.write('p1 = """' + imports_and_state + fetch_data + helpers_and_saving + mouse_handlers + element_handlers + group_handlers + '"""\n')
